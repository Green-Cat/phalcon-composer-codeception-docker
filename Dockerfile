...
RUN apt-get install -y -q php5-dev php5-mcrypt php5-curl php5-pgsql php5-mysql php5-sqlite php5-mongo php5-memcached php5-xdebug php-apc php5-imagick php5-gd php5-geoip gcc git libpcre3-dev wget
