...
RUN apt-get install -y -q -f php5-dev php5-mcrypt php5-curl php5-mongo php5-json php5-memcached php5-xdebug php5-gd php5-geoip libtool git libpcre3-dev curl wget
